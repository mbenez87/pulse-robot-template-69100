...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="absolute -top-[10%] -right-[5%] w-1/2 h-[70%] bg-pulse-gradient opacity-40 blur-3xl rounded-full"></div>
      ...
      <div className="hidden lg:block absolute bottom-0 left-1/4 w-64 h-64 bg-pulse-500/30 rounded-full blur-3xl -z-10 parallax" data-speed="0.05"></div>
    </section>
  );
};
